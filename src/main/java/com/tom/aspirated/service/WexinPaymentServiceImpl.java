...
import com.tom.aspirated.common.bo.wmp.xml.weixinpayment.UnifiedOrderRequestXml;
import com.tom.aspirated.common.bo.wmp.xml.weixinpayment.UnifiedOrderResponseXml;
...
public class WexinPaymentServiceImpl implements WexinPaymentService {
	...
	public void unifiedOrder(UUID orderUC, String ipAddress, String AT) throws Exception {
		...
		// dataAccessService.queryForOneRowAllColumn("ES_ORDER", orderUC);
